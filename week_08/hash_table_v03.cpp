...
struct student;
typedef unique_ptr<student> pStudent;
...
class hash_table_first_and_last : public hash_table_generic{
    ...
    student* search(string f, string l){
        ...
        pStudent tmp_student(new student(f,l,0.0));

        // get a hash key
        student* p_tmp_student = tmp_student.get();
        int key = hash_function(p_tmp_student);
...
class hash_table_last : public hash_table_generic{
    ...
    student* search(string l){
        ...
        pStudent tmp_student (new student("",l,0.0));
        student* p_tmp_student = tmp_student.get();
...
int main(){
    ...
    pStudent s1(new student("iyad","obeid",4.0));
    pStudent s2(new student("joe","picone",3.5));
    pStudent s3(new student("john","helferty",3.9));
    pStudent s4(new student("nhoj","helferty",3.7));
    pStudent s5(new student("nhoj","helferty",3.1));
